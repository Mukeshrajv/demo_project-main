...
class HomeContoller extends GetxController{
  ...
  List<dynamic> noCategoryData=[].obs ;
    List<dynamic> subCategoryData=[].obs ;
     RxList<dynamic> subSubCategoryData=[].obs ;
       var isLoading = false.obs;
       var subisLoading=false.obs;
       var listisLoading=false.obs;
 ...
 void _showAlertDialog(BuildContext context) {
  ...
  Future<void> fetchDataAndNavigate(context) async {
    ...
    await fetchCategoryApi(context);
...
// print(_categoryLoaded);
  ...
  Future<void> fetchCategoryApi(context)async{
