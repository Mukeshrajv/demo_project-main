...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  onPressed: () {
    ...
    //  Navigator.pop(context);
      ...
      body: SafeArea(
        child: Obx(() =>shippingController.paymentLoading.value ?
